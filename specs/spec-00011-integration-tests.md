...
**US-001:** Test --user scan end-to-end As a developer, I want an integration test that creates temp skills in $HOME paths and verifies they're found.

**US-002:** Test --repo requires git As a developer, I want a test that verifies `--repo` fails when outside a git repo.

**US-003:** Test --tool error handling As a developer, I want tests for unknown tools, missing directories, and partial availability.

**US-004:** Test duplicate detection As a developer, I want a test that creates same-named skills and verifies duplicate warning.

**US-005:** Test exit codes As a developer, I want tests verifying each exit code scenario.
