...
**US-001:** Validate in parallel
As a scanner, I want to validate 100+ skills efficiently using all CPU cores.

**US-002:** Collect all errors
As a user, I want to see every validation issue, not just the first failure.

**US-003:** Handle malformed skills gracefully
As a scanner, if one skill has unparseable TOML, I want it logged but other validations continue.
