...
## [0.3.0](https://github.com/moutons/skills-validator/compare/v0.2.1...v0.3.0) - 2026-05-18

### Other

- *(deps)* bump release-plz/action from 0.5.128 to 0.5.129 ([#36](https://github.com/moutons/skills-validator/pull/36))
- *(deps)* bump DavidAnson/markdownlint-cli2-action from 23.1.0 to 23.2.0 ([#35](https://github.com/moutons/skills-validator/pull/35))
- *(deps)* bump DavidAnson/markdownlint-cli2-action
