...
**US-001:** Detect same-name skills As a user, I want to know when two skills share the same `name` in frontmatter.

**US-002:** Validate both duplicates As a scanner, I want to validate both instances of a duplicate skill, not skip one.

**US-003:** Clear warning output As a user, I want the warning to tell me which files conflict and suggest checking precedence.
